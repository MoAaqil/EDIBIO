...
"[project]/app/api/admin/action/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        switch(action){
            case 'WIPE_ACCOUNT':
                ...
                const companies = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CompanyData"].find({
                    userId
                }).select('_id').lean();
                const companyIds = companies.map((c)=>c._id);
                // 2. Delete all child data
                await Promise.all([
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PartyData"].deleteMany({
                        companyId: {
                            $in: companyIds
                        }
                    }),
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ProductData"].deleteMany({
                        companyId: {
                            $in: companyIds
                        }
                    }),
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["InvoiceData"].deleteMany({
                        companyId: {
                            $in: companyIds
                        }
                    }),
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ExpenseData"].deleteMany({
                        companyId: {
                            $in: companyIds
                        }
                    }),
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CompanyData"].deleteMany({
                        userId
                    })
                ]);
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Account wiped successfully'
                });
            case 'DELETE_COMPANY':
                ...
                await Promise.all([
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CompanyData"].findByIdAndDelete(companyId)
                ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__23803973._.js.map