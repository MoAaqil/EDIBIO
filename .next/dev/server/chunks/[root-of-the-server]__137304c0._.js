...
"[project]/app/api/logistics/loads/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const loads = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsLoad"].find(query).sort({
            createdAt: -1
        }).limit(limit).lean();
...
async function POST(req) {
    try {
        ...
        if (!data.loadNumber) {
            const count = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsLoad"].countDocuments({
                companyId
            });
            data.loadNumber = `LS-${String(count + 1001).padStart(5, '0')}`;
        }
        const load = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsLoad"].create({
            ...data,
            companyId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__137304c0._.js.map