...
"[project]/app/api/logistics/vehicles/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const vehicles = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsVehicle"].find(query).sort({
            vehicleNumber: 1
        }).lean();
...
async function POST(req) {
    try {
        ...
        const vehicle = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsVehicle"].create({
            ...data,
            companyId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__22cca4f8._.js.map