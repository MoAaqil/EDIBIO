...
"[project]/app/api/logistics/invoices/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const invoices = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsInvoice"].find({
            companyId
        }).sort({
            createdAt: -1
        }).limit(limit).lean();
...
async function POST(req) {
    try {
        ...
        if (!data.loadId || !data.amount || !data.totalAmount) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Missing loadId, amount, or totalAmount'
            }, {
                status: 400
            });
        }
        ...
        if (!data.invoiceNumber) {
            const count = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsInvoice"].countDocuments({
                companyId
            });
            data.invoiceNumber = `INV-LS-${new Date().getFullYear()}-${String(count + 1).padStart(4, '0')}`;
        }
        const invoice = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logistics$2f$models$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LsInvoice"].create({
            ...data,
            companyId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ed919a58._.js.map