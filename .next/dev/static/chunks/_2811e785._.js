...
function MongoSync() {
    _s();
    const { isAuthenticated, user, isDemo, setIsHydrating, setLastSyncedAt, setSyncStatus, setSyncError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MongoSync.useEffect": ()=>{
            ...
            const hydrationTimeout = setTimeout({
                "MongoSync.useEffect.hydrationTimeout": ()=>{
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].getState().isHydrating) {
                        console.warn('[MongoSync] Hydration timed out, forcing false');
                        setIsHydrating(false);
                    }
                }
            }["MongoSync.useEffect.hydrationTimeout"], 15000);
            ...
            return ({
                "MongoSync.useEffect": ()=>clearTimeout(hydrationTimeout)
            })["MongoSync.useEffect"];
        }
    }["MongoSync.useEffect"], [
        isAuthenticated,
            ...
            const sub = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].subscribe({
                "MongoSync.useEffect.sub": (state)=>{
                    ...
                    if (sig !== prevStateStr.current) {
                        ...
                        const t = setTimeout({
                            "MongoSync.useEffect.sub.t": ()=>sync()
                        }["MongoSync.useEffect.sub.t"], 5000);
                        return ({
                            "MongoSync.useEffect.sub": ()=>clearTimeout(t)
        ...
        "MongoSync.useEffect": ()=>{
            window.forceEdibioCloudSync = ({
                "MongoSync.useEffect": async ()=>{
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].loading('Force Syncing...', {
                        id: 'forcesync'
                    });
                    try {
                        const s = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].getState();
...
_s(MongoSync, "Yf+8OkE06j5dxEGco/iizJNnzrc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
});
...
//# sourceMappingURL=_2811e785._.js.map