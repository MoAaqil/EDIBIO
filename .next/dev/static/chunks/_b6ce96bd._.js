    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InitialLoader.useEffect": ()=>{
            if (!sessionStorage.getItem('edibio_loaded')) {
                ...
                }["InitialLoader.useEffect.timer"], 1800);
                return ({
...
_s1(InitialLoader, "J7PPXooW06IQ11rfabbvgk72KFw=");
_c1 = InitialLoader;
...
_s2(SubscriptionGuard, "JDskSNQ4Ob5ZB0NJo0aFMSu7Esw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c2 = SubscriptionGuard;
...
_s3(AppLayout, "5rGDkYpGQ8fHM9RkMWnKOwsxadk=");
_c3 = AppLayout;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "DemoBanner");
__turbopack_context__.k.register(_c1, "InitialLoader");
__turbopack_context__.k.register(_c2, "SubscriptionGuard");
...
function DashboardPage() {
    _s();
    const { activeCompanyId, isHydrating } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    ...
    const recentInvoices = invoices.filter((i)=>i.isGstBill).length > 0 ? invoices.filter((i)=>i.isGstBill).slice(0, 6) : invoices.slice(0, 6);
    ...
    const trendData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[trendData]": ()=>{
            const data = [];
            for(let i = 6; i >= 0; i--){
                const date = new Date();
                date.setDate(date.getDate() - i);
                const dateStr = date.toISOString().slice(0, 10);
                const dayTotal = invoices.filter({
                    "DashboardPage.useMemo[trendData].dayTotal": (inv)=>inv.date === dateStr && inv.invoiceType === 'sale'
                }["DashboardPage.useMemo[trendData].dayTotal"]).reduce({
                    "DashboardPage.useMemo[trendData].dayTotal": (sum, inv)=>sum + (inv.grandTotal || 0)
                }["DashboardPage.useMemo[trendData].dayTotal"], 0);
                data.push({
    ...
    const totalReceivable = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[totalReceivable]": ()=>parties.filter({
                "DashboardPage.useMemo[totalReceivable]": (p)=>p.balance > 0
            }["DashboardPage.useMemo[totalReceivable]"]).reduce({
                "DashboardPage.useMemo[totalReceivable]": (a, p)=>a + p.balance
            }["DashboardPage.useMemo[totalReceivable]"], 0)
    }["DashboardPage.useMemo[totalReceivable]"], [
        parties
    ]);
    const totalPayable = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[totalPayable]": ()=>parties.filter({
                "DashboardPage.useMemo[totalPayable]": (p)=>p.balance < 0
            }["DashboardPage.useMemo[totalPayable]"]).reduce({
                "DashboardPage.useMemo[totalPayable]": (a, p)=>a + Math.abs(p.balance)
            }["DashboardPage.useMemo[totalPayable]"], 0)
    }["DashboardPage.useMemo[totalPayable]"], [
        parties
    ]);
    const lowStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[lowStock]": ()=>products.filter({
                "DashboardPage.useMemo[lowStock]": (p)=>p.stockQty <= (p.lowStockAlertQty || 5)
            }["DashboardPage.useMemo[lowStock]"])
    }["DashboardPage.useMemo[lowStock]"], [
        products
    ]);
    const stockValue = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[stockValue]": ()=>products.reduce({
                "DashboardPage.useMemo[stockValue]": (a, p)=>a + p.stockQty * p.purchasePrice
            }["DashboardPage.useMemo[stockValue]"], 0)
    }["DashboardPage.useMemo[stockValue]"], [
        products
    ]);
    const insights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DashboardPage.useMemo[insights]": ()=>{
            const calculated = [];
            const saleInvs = invoices.filter({
                "DashboardPage.useMemo[insights].saleInvs": (i)=>i.invoiceType === 'sale'
            }["DashboardPage.useMemo[insights].saleInvs"]);
            // Top seller
            const itemMap = {};
            saleInvs.forEach({
                "DashboardPage.useMemo[insights]": (inv)=>(inv.items || []).forEach({
                        "DashboardPage.useMemo[insights]": (it)=>{
            ...
            const topItem = Object.values(itemMap).sort({
                "DashboardPage.useMemo[insights]": (a, b)=>b.qty - a.qty
            }["DashboardPage.useMemo[insights]"])[0];
            if (topItem) calculated.push({
                emoji: '📈',
                text: `<b>${topItem.name}</b> is your top-selling product (${topItem.qty} units sold).`,
                color: '#34A853'
            });
            // Out of stock
            const oos = products.filter({
                "DashboardPage.useMemo[insights].oos": (p)=>p.stockQty <= 0
            }["DashboardPage.useMemo[insights].oos"]);
            if (oos.length) calculated.push({
                emoji: '🚨',
                text: `<b>${oos.length} item${oos.length > 1 ? 's' : ''}</b> are out of stock — reorder now to avoid lost sales.`,
                color: '#EA4335'
            });
            // Outstanding receivables
            if (totalReceivable > 0) calculated.push({
                emoji: '💰',
                text: `You have <b>₹${totalReceivable.toLocaleString('en-IN')}</b> in outstanding receivables from customers.`,
                color: '#FBBC04'
            });
            // Low stock
            const lowStockCount = products.filter({
                "DashboardPage.useMemo[insights]": (p)=>p.stockQty > 0 && p.stockQty <= (p.lowStockAlertQty || 5)
            }["DashboardPage.useMemo[insights]"]).length;
            if (lowStockCount > 0) calculated.push({
                emoji: '⚠️',
                text: `<b>${lowStockCount} product${lowStockCount > 1 ? 's are' : ' is'}</b> running low on stock. Consider reordering soon.`,
                color: '#F59E0B'
            });
            // Healthy message if all good
            if (!calculated.length) calculated.push({
                emoji: '✅',
                text: 'All systems look good! Stock is healthy and no outstanding payments.',
                color: '#34A853'
            });
            return calculated;
        }
    ...
    const quickLinks = [
        ...
        {
            label: 'Add Item',
            href: `/company/inventory/add`,
            color: '#FBBC04',
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$package$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Package$3e$__["Package"]
        },
        {
            label: 'Add Party',
            href: `/company/parties/add`,
            color: '#34A853',
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$users$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Users$3e$__["Users"]
        },
        {
            label: 'Add Expense',
            href: `/company/expenses/add`,
            color: '#EA4335',
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$dollar$2d$sign$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__DollarSign$3e$__["DollarSign"]
        },
        {
            label: 'Quick Bill',
            href: `/company/billing/quick`,
            color: '#4285F4',
    ...
    if (isHydrating) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AppLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        title: "Dashboard",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SkeletonDashboard"], {}, void 0, false, {
            fileName: "[project]/app/company/dashboard/page.tsx",
            lineNumber: 123,
            columnNumber: 13
        }, this)
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    ...
                                    height: 140,
                                    borderRadius: 999,
                                    background: `${company.colorAccent}20`
                                }
                            }, void 0, false, {
                                fileName: "[project]/app/company/dashboard/page.tsx",
                                lineNumber: 139,
                                ...
                                children: [
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    ...
                                                    " · ",
                                                    company.city,
                                                    " · Secure Multi-Device Sync Active"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/app/company/dashboard/page.tsx",
                                                lineNumber: 149,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        style: {
                                            ...
                                            alignItems: 'center',
                                            gap: 8,
                                            background: company.colorAccent,
                                            color: 'white',
                                            padding: '10px 18px',
                                            borderRadius: 12,
                                            textDecoration: 'none',
                                            fontWeight: 700,
                                            fontSize: 13,
                                            boxShadow: `0 4px 16px ${company.colorAccent}50`,
                                            flexShrink: 0
                                        },
                                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    {
                                        label: "Today's Sales",
                                        value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatShort"])(todayInv.reduce((a, i)=>a + i.grandTotal, 0)),
                                        sub: `${todayInv.length} bills`
                                    },
                                    {
                                        label: 'Collected',
                                        value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatShort"])(todayInv.reduce((a, i)=>a + i.amountPaid, 0)),
                                        sub: 'cash + UPI'
                                    },
                                    {
                                        label: 'Pending',
                                        value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatShort"])(todayInv.reduce((a, i)=>a + i.balanceDue, 0)),
                                        sub: 'to collect'
                                    }
                                ].map(({ label, value, sub })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        style: {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$AreaChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AreaChart"], {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$cartesian$2f$YAxis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["YAxis"], {
                                                ...
                                                tickFormatter: (val)=>`₹${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatShort"])(val)}`
                                            }, void 0, false, {
                                                fileName: "[project]/app/company/dashboard/page.tsx",
                                                lineNumber: 209,
                                                columnNumber: 33
                    ...
                    lowStock.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        href: `/company/inventory?filter=low`,
                        style: {
                            display: 'flex',
                            alignItems: 'center',
                            gap: 12,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KPICard, {
                                label: "To Receive",
                                value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatShort"])(totalReceivable),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KPICard, {
                                label: "To Pay",
                                value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatShort"])(totalPayable),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(KPICard, {
                                label: "Stock Value",
                                value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatShort"])(stockValue),
                                icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$package$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Package$3e$__["Package"],
                                color: "#FBBC04"
                            }, void 0, false, {
                                fileName: "[project]/app/company/dashboard/page.tsx",
                    ...
                    insights.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Smart Business Insights"
                                            }, void 0, false, {
                                                fileName: "[project]/app/company/dashboard/page.tsx",
                                                lineNumber: 263,
                                                columnNumber: 33
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Powered by your store data"
                                            }, void 0, false, {
                                                fileName: "[project]/app/company/dashboard/page.tsx",
                                                lineNumber: 264,
                                                columnNumber: 33
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: insights.slice(0, 3).map((ins, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        style: {
                                            display: 'flex',
                                            alignItems: 'flex-start',
                                            gap: 10,
                    ...
                    (()=>{
                        const overdue = parties.filter((p)=>p.balance > 500);
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Pending Payment Reminders"
                                        }, void 0, false, {
                                            fileName: "[project]/app/company/dashboard/page.tsx",
                                            lineNumber: 287,
                                            columnNumber: 33
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        overdue.slice(0, 3).map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                style: {
                                                    display: 'flex',
                                                    alignItems: 'center',
                                                    gap: 10,
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: (p.name || 'P')[0].toUpperCase()
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/company/dashboard/page.tsx",
                                                        lineNumber: 293,
                                                        columnNumber: 41
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                        href: `https://wa.me/${(p.phone || '').replace(/\D/g, '')}?text=${encodeURIComponent(`Hi ${p.name}, this is a gentle reminder that you have a pending payment of ₹${p.balance} at ${company?.name || 'our store'}. Please pay at your earliest convenience. Thank you!`)}`,
                                                        target: "_blank",
                                        ...
                                        overdue.length > 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            style: {
                                                fontSize: 12,
                                                color: '#065F46',
                                                fontWeight: 600,
                                            ...
                                            children: [
                                                "+ ",
                                                overdue.length - 3,
                                                " more customers with pending payments"
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/app/company/dashboard/page.tsx",
                                            lineNumber: 307,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: quickLinks.map(({ label, href, color, icon: Icon })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: href,
                                        style: {
                                            display: 'flex',
                                            flexDirection: 'column',
                    ...
                    (company?.godowns?.length || 0) > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "card",
                        style: {
                            padding: '20px 24px'
                        },
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: company?.godowns?.map((g, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        style: {
                                            flex: 1,
                                            padding: '14px 16px',
                                            borderRadius: 12,
                                            background: idx === 0 ? '#E8F0FE' : '#E6F4EA',
                                            border: `1.5px solid ${idx === 0 ? '#4285F4' : '#34A853'}30`
                                        },
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$warehouse$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Warehouse$3e$__["Warehouse"], {
                                                size: 16,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    products.filter((p)=>p.godownId === g.id || !p.godownId && idx === 0).length,
                                                    " items"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/app/company/dashboard/page.tsx",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            recentInvoices.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: recentInvoices.map((inv)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$text$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileText$3e$__["FileText"], {
                                                    size: 18,
                                                    color: inv.invoiceType === 'sale' ? '#EA4335' : '#4285F4'
                                                }, void 0, false, {
                                                    fileName: "[project]/app/company/dashboard/page.tsx",
                                                    lineNumber: 388,
                                                    columnNumber: 41
...
_s(DashboardPage, "x6++ROPDxbqxKN3ypRe+gxd/ZmU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useActiveCompany"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCompanyData"],
...
//# sourceMappingURL=_b6ce96bd._.js.map