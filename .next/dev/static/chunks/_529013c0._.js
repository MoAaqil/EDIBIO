    ...
    const fetchStores = async ()=>{
        ...
        try {
            ...
            snap.forEach((docSnap)=>{
                ...
                const plan = uo.subscriptionType || uo.plan || 'free';
                ...
                if (days <= 7) notifs.push({
                    msg: `🆕 New: ${uo.name || data.email}`,
                    type: 'new'
                });
                if (days > 30) notifs.push({
                    msg: `😴 Idle 30d+: ${uo.name || data.email}`,
                    type: 'inactive'
                });
                if (plan === 'expired_subscription') notifs.push({
                    msg: `❌ Expired: ${uo.name || data.email}`,
                    type: 'expired'
                });
                list.push({
                    docId: docSnap.id,
...
_s(RegisteredStoresPage, "qhKWAXrY7V2z1oTIlrr7S3ZQjYI=");
...
//# sourceMappingURL=_529013c0._.js.map