...
__turbopack_context__.v((parentImport) => {
  ...
  "static/chunks/node_modules_firebase_firestore_dist_esm_index_esm_0ecb8780.js"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {
        return parentImport("[project]/node_modules/firebase/firestore/dist/esm/index.esm.js [app-client] (ecmascript)");
    });
});
}),
"[project]/lib/store.ts [app-client] (ecmascript, async loader)", ((__turbopack_context__) => {

__turbopack_context__.v((parentImport) => {
    return Promise.resolve().then(() => {
        return parentImport("[project]/lib/store.ts [app-client] (ecmascript)");
    });
});
}),
]);