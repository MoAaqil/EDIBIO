...
function ManagePlansPage() {
        ...
        try {
            ...
            snap.forEach((docSnap)=>{
                ...
                if (data.compressedState) {
                    try {
                        state = JSON.parse(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].decompressFromUTF16(data.compressedState) || '{}');
                    } catch  {}
                } else if (data.stateString) {
                    try {
                        state = JSON.parse(data.stateString);
                    } catch  {}
                }
                const uo = typeof state.user === 'object' && state.user ? state.user : {};
                const plan = (uo.subscriptionType || uo.plan || 'free').toLowerCase();
                const expiry = uo.subscriptionExpiresAt || uo.planExpiresAt || null;
                let daysLeft = null;
                let isExpired = false;
                if (expiry) {
                ...
                list.push({
                    docId: docSnap.id,
                    name: uo.name || data.email || 'Unknown',
                    email: uo.email || data.email || 'N/A',
                    phone: uo.phone || 'N/A',
                    plan,
                    planExpiry: expiry,
                    fullState: state,
    ...
    const applyPlan = async ()=>{
        ...
        try {
            const state = {
                ...editingUser.fullState
            };
            if (!state.user) state.user = {};
            const expiry = selectedPlan !== 'free' ? new Date(Date.now() + renewMonths * 30 * 86400000).toISOString() : null;
            state.user.subscriptionType = selectedPlan;
            state.user.plan = selectedPlan;
            if (expiry) state.user.subscriptionExpiresAt = expiry;
            else delete state.user.subscriptionExpiresAt;
            ...
            const compressed = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].compressToUTF16(JSON.stringify(state));
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], 'userStores', editingUser.docId), {
                compressedState: compressed,
                updatedAt: new Date().toISOString()
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Plan updated to ${selectedPlan} for ${editingUser.name}`);
            setEditingUser(null);
            fetchUsers();
        } catch  {
    ...
    const revokePlan = async (user)=>{
        const yes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ConfirmDialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["confirm"])({
            message: `Revert ${user.name}'s plan to Free Trial?`,
            danger: true
        });
        if (!yes) return;
        try {
            ...
            delete state.user.subscriptionExpiresAt;
            if (!state.planHistory) state.planHistory = [];
            state.planHistory.push({
                plan: 'free',
                assignedAt: new Date().toISOString(),
                by: 'super_admin_revoke'
            });
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], 'userStores', user.docId), {
                compressedState: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].compressToUTF16(JSON.stringify(state)),
                updatedAt: new Date().toISOString()
            });
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Plan reverted to Free Trial');
            fetchUsers();
        } catch  {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Failed to revoke plan');
        }
    };
    const getPlanStyle = (plan)=>{
        ...
        if (plan === 'expired_subscription' || plan === 'expired') return {
            bg: '#FEE2E2',
            color: '#B91C1C',
            icon: '❌'
        };
    ...
    const filtered = users.filter((u)=>{
        ...
        const mF = filter === 'all' ? true : filter === 'free' ? u.plan === 'free' || u.plan === 'free trial' : filter === 'paid' ? u.plan === 'standard' || u.plan === 'premium' : filter === 'expired' ? u.isExpired : u.daysLeft !== null && u.daysLeft > 0 && u.daysLeft <= 30;
        return mQ && mF;
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Assign, renew, or revoke plans for any account — including hand-paid customers."
                    }, void 0, false, {
                        fileName: "[project]/app/admin/plans/page.tsx",
                        lineNumber: 192,
                        columnNumber: 17
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                ].map(({ label, value, icon: Icon, bg, c })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mp-stat",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                style: {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    'expiring'
                        ...
                        onClick: ()=>setFilter(f),
                        className: `mp-filter-btn${filter === f ? ' mp-filter-active' : ''}`,
                        style: {
                            textTransform: 'capitalize'
                        },
                        children: f === 'expiring' ? '⚠️ Expiring Soon' : f
                    }, f, false, {
                        fileName: "[project]/app/admin/plans/page.tsx",
                        lineNumber: 218,
                        columnNumber: 21
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        user.planExpiry && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mp-expiry",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    style: {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    style: {
                                        fontSize: 11,
                                        fontWeight: 800,
                                        color: user.isExpired ? '#EF4444' : user.daysLeft <= 30 ? '#F59E0B' : '#10B981'
                                    },
                                    children: user.isExpired ? '⛔ Expired' : `${user.daysLeft}d left`
                                }, void 0, false, {
                                    fileName: "[project]/app/admin/plans/page.tsx",
                                    lineNumber: 241,
                                    columnNumber: 37
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                user.plan !== 'free' && user.plan !== 'free trial' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: editingUser.plan
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin/plans/page.tsx",
                                            lineNumber: 280,
                                            columnNumber: 33
                                        }, this),
                                        editingUser.planExpiry && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            style: {
                                                fontSize: 10,
                                                color: '#94A3B8',
                                                marginTop: 2
                                            ...
                                            children: [
                                                "Expires: ",
                                                new Date(editingUser.planExpiry).toLocaleDateString('en-IN')
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/app/admin/plans/page.tsx",
                                            lineNumber: 281,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: PLANS.map((plan)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    style: {
                                                        ...
                                                        background: selectedPlan === plan.id ? plan.bg : 'white'
                                                    },
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: selectedPlan === plan.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                style: {
                                                                    width: 9,
                                                                    height: 9,
                                                                    borderRadius: 99,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                24
                                                    ...
                                                    className: "dur-btn",
                                                    style: {
                                                        borderColor: renewMonths === m ? '#7C3AED' : '#E2E8F0',
                                                        background: renewMonths === m ? '#EDE9FE' : 'white',
                                                        color: renewMonths === m ? '#7C3AED' : '#64748B'
                                                    },
                                                    children: [
                                                        m,
                                                        "M"
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: [
                                        ...
                                        " ",
                                        saving ? 'Saving…' : `Apply ${selectedPlan} Plan`
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/app/admin/plans/page.tsx",
                                    lineNumber: 324,
            ...
            historyUser && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "modal-overlay",
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: (historyUser.fullState?.planHistory || []).length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    textAlign: 'center',
                                    color: '#94A3B8',
                                    padding: 24
                                ...
                                ...historyUser.fullState?.planHistory || []
                            ].reverse().map((h, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    style: {
                                        display: 'flex',
                                        gap: 10,
                                        marginBottom: 12,
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            style: {
                                                ...
                                                height: 30,
                                                borderRadius: 8,
                                                background: h.plan === 'premium' ? '#FEF3C7' : h.plan === 'standard' ? '#EEF2FF' : '#F1F5F9',
                                                display: 'flex',
                                                alignItems: 'center',
                                                justifyContent: 'center',
                                                flexShrink: 0
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$credit$2d$card$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CreditCard$3e$__["CreditCard"], {
                                                size: 13,
                                                color: h.plan === 'premium' ? '#D97706' : h.plan === 'standard' ? '#4338CA' : '#64748B'
                                            }, void 0, false, {
                                                fileName: "[project]/app/admin/plans/page.tsx",
                                                lineNumber: 352,
                                                columnNumber: 41
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        ...
                                                        h.expiresAt ? ` → ${new Date(h.expiresAt).toLocaleDateString('en-IN')}` : ''
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/app/admin/plans/page.tsx",
                                                    lineNumber: 356,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: [
                                                        "by ",
                                                        h.by === 'super_admin' ? '🛡️ Super Admin' : h.by || 'system'
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/app/admin/plans/page.tsx",
                                                    lineNumber: 360,
...
_s(ManagePlansPage, "hZcFjL51Wg7rzAyYPF7W/x80eTQ=");
_c = ManagePlansPage;
var _c;
__turbopack_context__.k.register(_c, "ManagePlansPage");
...
//# sourceMappingURL=_bb0c826a._.js.map