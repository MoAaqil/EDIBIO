...
const useCompanyData = (type)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCompanyData.useMemo": ()=>(items || []).filter({
                "useCompanyData.useMemo": (i)=>i.companyId === activeCompanyId
...
_s1(useCompanyData, "hb34l8PYE41Nu7/G362ApzEdshw=", false, function() {
    return [
        useStore
    ];
});
...
const useStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        // CRITICAL FIX: logout only clears SESSION, not company data.
        // Companies, invoices, products etc stay in local DB.
        logout: ()=>set({
                user: null,
                isAuthenticated: false,
...
"[project]/components/CloudSync.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CloudSync() {
    _s();
    const { user, isAuthenticated, isDemo, setIsHydrating, syncStatus, setSyncStatus, lastSyncedAt, setLastSyncedAt, syncError, setSyncError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    ...
    const sync = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CloudSync.useCallback[sync]": async (isManual = false)=>{
            const _s = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].getState();
            ...
            try {
                ...
                const compressed = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].compressToUTF16(JSON.stringify(payload));
                const now = Date.now();
                const docRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], 'userStores', user.uid);
                ...
                setSyncStatus('saved');
                setIsHydrating(false);
                if (isManual) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Sync Successful (v10)');
                setTimeout({
                    "CloudSync.useCallback[sync]": ()=>setSyncStatus('idle')
                }["CloudSync.useCallback[sync]"], 2000);
                setSyncError(null);
            } catch (err) {
                ...
                setIsHydrating(false);
                if (isManual) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Sync failed. Check connection.');
            }
        }
    }["CloudSync.useCallback[sync]"], [
        isAuthenticated,
        user?.uid,
        isDemo,
        setIsHydrating,
                ...
                "CloudSync.useEffect": async ()=>{
                    try {
                        ...
                        if (cloudTime > localTime) {
                            const cloudState = JSON.parse(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lz$2d$string$2f$libs$2f$lz$2d$string$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].decompressFromUTF16(data.compressedState) || '{}');
                            const local = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].getState();
                            const keys = [
                                'companies',
                                'parties',
                                'products',
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Data recovered from cloud ☁️');
                        }
            ...
            const sub = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].subscribe({
                "CloudSync.useEffect.sub": (state)=>{
                    ...
                    if (sig !== prevStateStr.current) {
                        ...
                        const t = setTimeout({
                            "CloudSync.useEffect.sub.t": ()=>sync()
                        }["CloudSync.useEffect.sub.t"], 5000);
                        return ({
                            "CloudSync.useEffect.sub": ()=>clearTimeout(t)
                        })["CloudSync.useEffect.sub"];
                    }
                }
            }["CloudSync.useEffect.sub"]);
            return ({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CloudSync.useEffect": ()=>{
            const t = setInterval({
                "CloudSync.useEffect.t": ()=>sync()
            }["CloudSync.useEffect.t"], SYNC_INTERVAL);
            return ({
                "CloudSync.useEffect": ()=>clearInterval(t)
            })["CloudSync.useEffect"];
        }
    }["CloudSync.useEffect"], [
        sync
        ...
        "CloudSync.useEffect": ()=>{
            window.forceEdibioCloudSync = ({
                "CloudSync.useEffect": async ()=>{
                    ...
                    setIsHydrating(true);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].loading('Forcing Cloud Sync...', {
                        id: 'forcesync'
                    });
                    try {
                        const snap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDoc"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"], 'userStores', user.uid));
                        if (snap.exists() && snap.data().compressedState) {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Force Sync Complete!', {
                                id: 'forcesync'
                            });
                        } else {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Sync failed', {
                            id: 'forcesync'
                        });
                    }
                    setIsHydrating(false);
...
_s(CloudSync, "95NzFZOUuH4al/qbSTCq9sUWQzg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
});
_c = CloudSync;
var _c;
__turbopack_context__.k.register(_c, "CloudSync");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                ...
                                children: opts.title || (opts.danger ? 'Confirm Delete' : 'Are you sure?')
                            }, void 0, false, {
                                fileName: "[project]/components/ConfirmDialog.tsx",
                                lineNumber: 64,
                                columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: opts.confirmLabel || (opts.danger ? 'Delete' : 'Confirm')
                            }, void 0, false, {
                                fileName: "[project]/components/ConfirmDialog.tsx",
                                lineNumber: 76,
                                columnNumber: 21
...
_s(ConfirmDialog, "4rzlVvJsP0eKoEV/xM3tfcKrw5k=");
_c = ConfirmDialog;
var _c;
...
//# sourceMappingURL=_5ef21a56._.js.map