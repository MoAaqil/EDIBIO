module.exports=[73570,a=>{"use strict";let b=(0,a.i(70106).default)("triangle-alert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);a.s(["AlertTriangle",()=>b],73570)},81779,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(73570),e=a.i(81560),f=a.i(33441),g=a.i(33508);let h=null,i=null;function j(a){return new Promise(b=>{h=b,i?.(a)})}function k(){let[a,j]=(0,c.useState)(null);(0,c.useEffect)(()=>(i=j,()=>{i===j&&(i=null)}),[]);let k=(0,c.useCallback)(a=>{h?.(a),h=null,j(null)},[]);if(!a)return null;let l=()=>a.danger?"#EF4444":a.success?"#10B981":"#F59E0B";return(0,b.jsxs)("div",{style:{position:"fixed",inset:0,background:"rgba(15, 23, 42, 0.45)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:99999,padding:20,backdropFilter:"blur(8px)",animation:"confirmFadeIn 0.2s ease-out"},onClick:()=>k(!1),children:[(0,b.jsxs)("div",{style:{background:"white",borderRadius:24,padding:"32px 28px 24px",width:"100%",maxWidth:360,boxShadow:"0 25px 50px -12px rgba(0, 0, 0, 0.25)",animation:"confirmScaleIn 0.2s cubic-bezier(0.34, 1.56, 0.64, 1)",position:"relative",border:"1px solid #F1F5F9"},onClick:a=>a.stopPropagation(),children:[(0,b.jsx)("button",{onClick:()=>k(!1),style:{position:"absolute",top:18,right:18,background:"#F8FAFC",border:"none",borderRadius:"50%",width:30,height:30,display:"flex",alignItems:"center",justifyContent:"center",color:"#94A3B8",cursor:"pointer",transition:"all 0.15s"},onMouseEnter:a=>{a.currentTarget.style.background="#F1F5F9",a.currentTarget.style.color="#64748B"},onMouseLeave:a=>{a.currentTarget.style.background="#F8FAFC",a.currentTarget.style.color="#94A3B8"},children:(0,b.jsx)(g.X,{size:14})}),(0,b.jsxs)("div",{style:{textAlign:"center",marginBottom:24},children:[(0,b.jsx)("div",{style:{width:60,height:60,borderRadius:"50%",background:a.danger?"#FEF2F2":a.success?"#ECFDF5":"#FFFBEB",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 18px"},children:a.danger?(0,b.jsx)(e.Trash2,{size:26,color:l()}):a.success?(0,b.jsx)(f.Check,{size:26,color:l()}):(0,b.jsx)(d.AlertTriangle,{size:26,color:l()})}),(0,b.jsx)("h3",{style:{fontWeight:900,fontSize:18,color:"#0F172A",margin:"0 0 10px",fontFamily:"'Outfit', sans-serif"},children:a.title||(a.danger?"Confirm Delete":a.success?"Confirm Action":"Are you sure?")}),(0,b.jsx)("p",{style:{fontSize:13.5,color:"#475569",lineHeight:1.5,margin:0,padding:"0 8px"},children:a.message})]}),(0,b.jsxs)("div",{style:{display:"flex",gap:12},children:[(0,b.jsx)("button",{onClick:()=>k(!1),style:{flex:1,padding:"12px 16px",background:"white",color:"#475569",border:"1px solid #E2E8F0",borderRadius:14,fontWeight:700,cursor:"pointer",fontSize:14,transition:"all 0.15s"},onMouseEnter:a=>{a.currentTarget.style.background="#F8FAFC",a.currentTarget.style.borderColor="#CBD5E1"},onMouseLeave:a=>{a.currentTarget.style.background="white",a.currentTarget.style.borderColor="#E2E8F0"},children:"Cancel"}),(0,b.jsx)("button",{onClick:()=>k(!0),style:{flex:1,padding:"12px 16px",background:a.danger?"linear-gradient(135deg, #EF4444, #DC2626)":a.success?"linear-gradient(135deg, #10B981, #059669)":"linear-gradient(135deg, #3B82F6, #2563EB)",color:"white",border:"none",borderRadius:14,fontWeight:700,cursor:"pointer",fontSize:14,boxShadow:a.danger?"0 4px 14px rgba(239, 68, 68, 0.3)":a.success?"0 4px 14px rgba(16, 185, 129, 0.3)":"0 4px 14px rgba(59, 130, 246, 0.3)",transition:"all 0.15s"},onMouseEnter:b=>{b.currentTarget.style.transform="translateY(-1px)",b.currentTarget.style.boxShadow=a.danger?"0 6px 18px rgba(239, 68, 68, 0.4)":a.success?"0 6px 18px rgba(16, 185, 129, 0.4)":"0 6px 18px rgba(59, 130, 246, 0.4)"},onMouseLeave:b=>{b.currentTarget.style.transform="none",b.currentTarget.style.boxShadow=a.danger?"0 4px 14px rgba(239, 68, 68, 0.3)":a.success?"0 4px 14px rgba(16, 185, 129, 0.3)":"0 4px 14px rgba(59, 130, 246, 0.3)"},children:a.confirmLabel||(a.danger?"Delete":a.success?"Settle":"Confirm")})]})]}),(0,b.jsx)("style",{children:`
...
//# sourceMappingURL=_cf24aac4._.js.map