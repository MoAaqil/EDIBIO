...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},73570,a=>{"use strict";let b=(0,a.i(70106).default)("triangle-alert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);a.s(["AlertTriangle",()=>b],73570)},28790,a=>{"use strict";let b=(0,a.i(70106).default)("refresh-ccw",[["path",{d:"M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"14sxne"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16",key:"1hlbsb"}],["path",{d:"M16 16h5v5",key:"ccwih5"}]]);a.s(["RefreshCcw",()=>b],28790)},3171,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(73570),e=a.i(28790),f=a.i(6704);function g({error:a,reset:g}){return(0,c.useEffect)(()=>{console.error("Critical Global Error Caught:",a),setTimeout(()=>{f.toast.error("Critical System Error: "+(a.message||"Fatal crash"),{duration:6e3,position:"top-center",style:{background:"#DC2626",color:"white",fontWeight:600,borderRadius:12}})},100)},[a]),(0,b.jsx)("html",{lang:"en",children:(0,b.jsx)("body",{children:(0,b.jsx)("div",{style:{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#1A1A2E",padding:20},children:(0,b.jsxs)("div",{style:{maxWidth:450,width:"100%",padding:"40px 30px",textAlign:"center",background:"white",borderRadius:20,boxShadow:"0 20px 40px rgba(0,0,0,0.5)",display:"flex",flexDirection:"column",alignItems:"center"},children:[(0,b.jsx)("div",{style:{width:64,height:64,borderRadius:20,background:"#DC2626",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:20,boxShadow:"0 8px 16px rgba(220, 38, 38, 0.3)"},children:(0,b.jsx)(d.AlertTriangle,{size:32,color:"#FFFFFF"})}),(0,b.jsx)("h1",{style:{fontSize:24,fontWeight:900,color:"#1A1A2E",marginBottom:12},children:"Critical System Error"}),(0,b.jsxs)("p",{style:{fontSize:13,color:"#718096",marginBottom:24,lineHeight:1.5},children:["The application encountered a fatal error and could not continue.",(0,b.jsx)("br",{}),(0,b.jsx)("span",{style:{fontSize:11,display:"inline-block",marginTop:12,padding:"8px 12px",background:"#FEF2F2",borderRadius:8,color:"#991B1B",wordBreak:"break-word",border:"1px solid #FCA5A5"},children:a.message||"Unknown Application Crash"})]}),(0,b.jsxs)("button",{onClick:()=>window.location.reload(),style:{width:"100%",padding:"14px",background:"#1A1A2E",color:"white",border:"none",borderRadius:12,fontWeight:800,display:"flex",alignItems:"center",justifyContent:"center",gap:6,cursor:"pointer",transition:"all 0.15s",boxShadow:"0 8px 16px rgba(26,26,46,0.3)"},children:[(0,b.jsx)(e.RefreshCcw,{size:16})," Hard Restart Application"]})]})})})})}a.s(["default",()=>g])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__a1eab9a2._.js.map